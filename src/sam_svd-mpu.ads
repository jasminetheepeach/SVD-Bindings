...
package SAM_SVD.MPU is
   ...
   type MPU_RASR_Register is record
      ...
      --  Access permission field
      AP             : RASR_AP_Field := SAM_SVD.MPU.No_Access;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Instruction access disable bit
      XN             : RASR_XN_Field := SAM_SVD.MPU.I_Enabled;
      --  unspecified
   ...
   type RASR_A_Register is record
      ...
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Access permission field
      AP             : RASR_A1_AP_Field := SAM_SVD.MPU.No_Access;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Instruction access disable bit
      XN             : RASR_A1_XN_Field := SAM_SVD.MPU.I_Enabled;
      --  unspecified
      Reserved_29_31 : HAL.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
